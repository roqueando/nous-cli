...
nous-cli/0.2.7 linux-x64 node-v10.19.0
$ nous --help [COMMAND]
USAGE
  $ nous COMMAND
...
...
_See code: [src/commands/creer.ts](https://github.com/roqueando/nous-cli/blob/v0.2.7/src/commands/creer.ts)_
...
_See code: [src/commands/monter/index.ts](https://github.com/roqueando/nous-cli/blob/v0.2.7/src/commands/monter/index.ts)_
...
_See code: [src/commands/monter/service.ts](https://github.com/roqueando/nous-cli/blob/v0.2.7/src/commands/monter/service.ts)_
<!-- commandsstop -->
=======
# nous-cli
